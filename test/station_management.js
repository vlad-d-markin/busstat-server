...
var s_id_finder = function(title, callback) {
    StationModel.findOne({title: title}, function(err,station) {
        if (err) throw "Find station error";
        if (!station) throw "S_ID_FINDER station error";
        return callback(station.s_id);
    });
};


describe('Station management: getStation()', function () {
...
describe('Station management: createStation()', function () {
...
describe('Station management: deleteStation()', function () {
    var test_title = 'TEST_STATION_TITLE';
